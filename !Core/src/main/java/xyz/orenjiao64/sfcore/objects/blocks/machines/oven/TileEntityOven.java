...
import xyz.orenjiao64.sfcore.objects.blocks.machines.oven.OvenRecipes;
...
public class TileEntityOven extends TileEntity implements ITickable
{
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.oven");
    }
    ...
    public static boolean isBurning(TileEntityOven te)
    {
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
            BlockOven.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = OvenRecipes.getInstance().getOvenResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = OvenRecipes.getInstance().getOvenResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));
